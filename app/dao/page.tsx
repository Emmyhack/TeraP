          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="card card-hover text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Connect your wallet to participate in TeraP DAO governance and voting.
              </p>
              <button
                onClick={() => router.push('/')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Participate in TeraP platform governance through proposals and voting.
            </p>
          </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">
                      {state.user.terapBalance || 0} TERAP
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">
                      {state.platform?.daoTreasury || 0} TERAP
                    </dd>
                  </dl>
                </div>
              </div>
            ...
            <div className="sm:flex sm:items-center">
              <div className="sm:flex-auto">
                ...
                <p className="mt-2 text-sm text-gray-700">
                  Vote on active proposals and help shape the future of TeraP.
                </p>
              </div>
